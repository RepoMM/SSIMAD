...
<div class="messages index large-10 medium-9 columns">
    ...
    <?php foreach ($messages as $message): ?>
        <tr>
            ...
            <td>
                <?= $message->has('group') ? $this->Html->link($message->group->group_number, ['controller' => 'Groups', 'action' => 'view', $message->group->id]) : '' ?>
            </td>
            ...
            <td class="actions">
                ...
                <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $message->id], ['confirm' => __('Are you sure you want to delete # {0}?', $message->title)]) ?>
            </td>
        </tr>
